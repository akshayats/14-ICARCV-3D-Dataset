...
day as regularly as possible over 19 days (461 scenes) and subsequently, manually annotated with 18 different object 
...
\begin{itemize}
	...
	\item provides long-term observations of the same set of scenes at different times of the day, over several days in 3 weeks.
\end{itemize}
...
\begin{itemize}
	\item scenes collected from 20 unique tables, 3 times a day for 19 days and in total, 461 scenes.
...
We also aim to make our next datasets with scenes observed periodically at different scales (different times of a day, all days over weeks). We also want to consider tables of 
different kinds (cafeteria, kitchen, reading room) and rooms of different kinds (kitchen, cafeteria, offices) to be able to model more scenes in human environments keeping with the intention of our long term autonomous robotic learning research.
